...
### Get to know about all these vars in depth from our Docs. [Read Now from Here](https://TigerNetwork.gitbook.io/TigerMusicBot/config-vars/available-vars)
...
4. `MONGO_DB_URI` : Get mongo db [from here.](https://TigerNetwork.gitbook.io/TigerMusicBot/deployment/mongodb)
...
### How to get these? [Read from here](https://TigerNetwork.gitbook.io/TigerMusicBot/deployment/spotify)
...
### How to get these? [Read from here](https://TigerNetwork.gitbook.io/TigerMusicBot/config-vars/heroku-vars)
