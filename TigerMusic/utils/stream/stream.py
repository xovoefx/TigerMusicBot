...
import config
from TigerMusic import Carbon, YouTube, app
from TigerMusic.core.call import Tiger
from TigerMusic.misc import db
from TigerMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from TigerMusic.utils.exceptions import AssistantErr
from TigerMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from TigerMusic.utils.inline.playlist import close_markup
from TigerMusic.utils.pastebin import Tigerbin
from TigerMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Tiger.force_stop_stream(chat_id)
