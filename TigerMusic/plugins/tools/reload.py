...
from TigerMusic.utils.database import get_authuser_names, get_cmode
from TigerMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from TigerMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Tiger.stop_stream(message.chat.id)
    except:
        pass
