...
from TigerMusic.utils import (Tigerbin, get_channeplayCB,
                              seconds_to_min)
from TigerMusic.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from TigerMusic.utils.decorators.language import language, languageCB
from TigerMusic.utils.inline import queue_back_markup, queue_markup
